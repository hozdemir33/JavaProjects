...
Create the outer loop first and make sure it works, then create the inner loop.
You can use the substring method to get individual letters.
If you’re using a while loop, don’t forget to increment!
You will need an if statement to check if values are equal in order to add to the counter.
Don’t forget to reset the counter after each iteration.
